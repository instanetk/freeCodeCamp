function checkCashRegister(price, cash, cid){
  ...
  const total = (arr) => arr.map((x) => {return x[1];}).reduce(reducer).toFixed(2);
  console.log((Number(total(cid))), "[cid] total before");

  // Define callback function
 // let result = () => {return obj};
  ...
  function sort(due) {
   ...
   // change = 0;
    //obj = {status: status, change: output};
  //  console.log(obj);
  ...
  console.warn("JavaScript Algorithms and Data Structures Projects: Cash Register");
