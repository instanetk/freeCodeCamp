...
let dog = {
    name: "Banga",
    numLegs: 4,
    sayLegs: function() { return dog.name + " has " + dog.numLegs + " legs."; }
};

console.error("Object Oriented Programming: Create a Basic JavaScript Object");
console.log(dog);
...
console.warn("Object Oriented Programming: Use Dot Notation to Access the Properties of an Object");
...
console.error("Object Oriented Programming: Create a Method on an Object");
...
let doggo = {
    name: "Quilo",
    numLegs: 4,
    sayLegs: function() { return this.name + " also has " + this.numLegs + " legs."; }
};

console.warn("Object Oriented Programming: Make Code More Reusable with the this Keyword");
console.log(doggo.sayLegs());
...
console.error("Object Oriented Programming: Define a Constructor Function");
...
hound.name = "Paddington";
hound.color = "Brown";
hound.numLegs = 4;

console.warn("Object Oriented Programming: Use a Constructor to Create Objects");
console.log(hound);
...
let myDog = new Doggo("Aragorn", "Gold");

console.error("Object Oriented Programming: Extend Constructors to Receive Arguments");
console.log(myDog);
...
console.warn("Object Oriented Programming: Verify an Object's Constructor with instanceof");
console.log(myHouse);
...
function Bird(name) {
  ...
  console.error("Object Oriented Programming: Understand Own Properties");
  console.log(canary);
...
function Dog(name) {
  ...
  console.warn("Object Oriented Programming: Use Prototype Properties to Reduce Duplicate Code");
  console.log(beagle);
...
for (let property in spaniel){
    if (spaniel.hasOwnProperty(property)){
...
console.error("Object Oriented Programming: Iterate Over All Properties");
console.log(spaniel);
console.table(ownProps);
console.table(prototypeProps);
...
console.warn("// Object Oriented Programming: Understand the Constructor Property");
console.log(joinDogFraternity(spaniel));
...
console.error("// Object Oriented Programming: Change the Prototype to a New Object");
...
console.warn("Object Oriented Programming: Remember to Set the Constructor Property when Changing the Prototype");
console.log(spaniel.constructor);
...
let golden = new Dog("Rocinante");

console.error("Object Oriented Programming: Understand Where an Object’s Prototype Comes From");
console.log(golden);
console.log(golden.describe());
console.log(golden.eat());
console.log(Dog.prototype.isPrototypeOf(golden));
...
// Modify the code to show the correct prototype chain.
  ...
  console.warn("Object Oriented Programming: Understand the Prototype Chain");
...
console.error("Object Oriented Programming: Use Inheritance So You Don't Repeat Yourself");
...
let husky = Object.create(Animal.prototype);

console.warn("Object Oriented Programming: Inherit Behaviors from a Supertype");
console.log(husky.eat());
console.log(husky.constructor);
...
console.error("Object Oriented Programming: Set the Child's Prototype to an Instance of the Parent");
console.log(poodle.eat());  // Should print "nom nom nom"
...
let eagle = new Bird();
let malamute = new Dog();

console.warn("Object Oriented Programming: Reset an Inherited Constructor Property");
console.log(eagle.constructor);
console.log(malamute.constructor);
...
console.error("// Object Oriented Programming: Add Methods After Inheritance");
console.log(labrador.constructor);
console.log(labrador.eat()); // Should print "nom nom nom"
console.log(labrador.bark()); // Should print "Woof!"
...
console.warn("Object Oriented Programming: Override Inherited Methods");
...
console.error("Object Oriented Programming: Use a Mixin to Add Common Behavior Between Unrelated Objects");
...
function Bird() {
  ...
  let hummingbird = new Bird();

console.warn("Object Oriented Programming: Use Closure to Protect Properties Within an Object from Being Modified Externally");
console.log(hummingbird.getWeight());
...
console.error("Object Oriented Programming: Understand the Immediately Invoked Function Expression (IIFE)");
...
let funModule = function (){
  return {
    ...
    singMixin: function(obj) {
      console.log("Come Oh Ye Faithful!")
    }
  }
}();

console.warn("Object Oriented Programming: Use an IIFE to Create a Module");
